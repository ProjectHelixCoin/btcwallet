...
[![GoDoc](https://godoc.org/github.com/projecthelixcoin/btcwallet/walletdb?status.png)]
(http://godoc.org/github.com/projecthelixcoin/btcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/projecthelixcoin/btcwallet/walletdb

## Installation

```bash
$ go get github.com/projecthelixcoin/btcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/projecthelixcoin/btcwallet/walletdb#example-package--BasicUsage)  
