...
can be found [here](https://github.com/projecthelixcoin/btcd).  An alternative
...
https://github.com/projecthelixcoin/btcwallet/releases
...
```
git clone https://github.com/projecthelixcoin/btcwallet $GOPATH/src/github.com/projecthelixcoin/btcwallet
cd $GOPATH/src/github.com/projecthelixcoin/btcwallet
glide install
```
...
```bash
$ cp $GOPATH/src/github.com/projecthelixcoin/btcd/sample-btcd.conf ~/.btcd/btcd.conf
$ cp $GOPATH/src/github.com/projecthelixcoin/btcwallet/sample-btcwallet.conf ~/.btcwallet/btcwallet.conf
...
The [integrated github issue tracker](https://github.com/projecthelixcoin/btcwallet/issues)
